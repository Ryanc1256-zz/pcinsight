<?php
	class Page extends view{
		function displayContent(){
			...
			$html .= 'If you want to put a date in or it will get submited to queue Instantly, also when  you submit the post it will automaticly get accepted and will be able to be seen.'."\n";
			$html .= '</div>'."\n";
			...
			$html .= '<div class="user alert alert-dismissable alert-info">'."\n";
			$html .= '<a class="close" data-dismiss="alert" href="#">x</a>'."\n";
			$html .= 'The file selector below will be the image (logo) for your article, this image will be used for the cover on the carousel as well if you select it.'."\n";
			$html .= '</div>'."\n";
			$html .= '<div class="upload"><label for="file">Image: </label><input id="file" type="file" /></div>'."\n";
			...
			$html .= '</div>'."\n";
			$html .= '<input type="hidden" id="hiddenID" value="'.$_GET['id'].'" />'."\n";
			$html .= '<a href="index.php?p=6&amp;deletePOST=true&amp;id='.$_GET['id'].'" class="btn red"> Delete Article </a>'."\n";
